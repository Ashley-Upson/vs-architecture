...
It is not reached by `DrawioArchitectureRenderer` or `RenderLayout.BuildProjectRegion`. New Architecture generation work belongs in the typed project-region topology, terminal, horizontal-slot, vertical-column, normalization, ownership, and serialization stages.
