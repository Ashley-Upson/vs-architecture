...
{
    public Task<ProjectModel> BuildAsync(string projectFilePath, CancellationToken cancellationToken) => broker.BuildAsync(projectFilePath: projectFilePath, cancellationToken: cancellationToken);
}
