...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddArchitectureDiagram(this IServiceCollection services)
    {
        ...
        services.AddTransient<TreeSpacingLayoutRuleProcessingService>();
        services.AddTransient<ArchitecturalLayerRuleProcessingService>();
        services.AddTransient<CategoryRowLayoutRuleProcessingService>();
        services.AddTransient<ILayoutInitializationService, LayoutInitializationService>();

        services.AddTransient<ILayoutRuleProcessingService, FiniteCoordinatesLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, ConnectionEndpointsLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, ContextualCanvasLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, NodeSpacingLayoutRuleProcessingService>();
        ...
        services.AddTransient<ILayoutRuleProcessingService, SharedChainAlignmentLayoutRuleProcessingService>();
        ...
        services.AddTransient<ILayoutRuleProcessingService, LabelPositionLayoutRuleProcessingService>();
        ...
        services.AddTransient<ILayoutRuleProcessingService, ProjectBranchSpacingLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, ProjectParentCentringLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, ProjectSharedCentringLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, CanvasBoundsLayoutRuleProcessingService>();
        ...
        services.AddTransient<ILayoutRuleProcessingService, UnclassifiedLinkLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, SameLayerLinkLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, ExposureHandoffLinkLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, AdjacentLayerLinkLayoutRuleProcessingService>();
        services.AddTransient<ILayoutRuleProcessingService, DestinationLinkColourLayoutRuleProcessingService>();
        ...
        services.AddTransient<IDataModelArrangementService, DataModelArrangementService>();
